...
import 'package:lbluebook_logistics/page/favorite_page.dart';
import 'package:lbluebook_logistics/page/home_page.dart';
import 'package:lbluebook_logistics/page/profile_page.dart';
import 'package:lbluebook_logistics/page/ranking_page.dart';
...
class _BottomNavigatorState extends State<BottomNavigator> {
  ...
  final _activeColor = ColorPrimary;
  int _currentIndex = 0;
  ...
  void _onJumpTo(int index, {pageChange = false}) {
    if (!pageChange) {
      ...
      LbNavigator.getInstance().onBottomTabChange(index, _pages[index]);
    }
    setState(() {
      // 控制当前选中 tab
      _currentIndex = index;
